...
internal static partial class CdnHost
{
    ...
    /// </summary>
    internal static void Apply(DownloadOptions myOption, Video? selectedVideo, Audio? selectedAudio, AppConfig cfg)
    {
    ...
    internal static void Apply(DownloadOptions myOption, List<string> clips, AppConfig cfg)
    {
