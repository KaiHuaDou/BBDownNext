...
/// <summary>全部 CLI 选项与别名的静态定义，供根命令与 opus 子命令共享注册。</summary>
internal static class CliOptions
{
    ...
    internal static readonly Option<bool> Interactive = new("--interactive", ["-ia"]) { Description = "交互式选择清晰度" };
    ...
    internal static readonly Option<string> SelectPage = new("--select-page", ["-p"])
    {
        Description = """
        选择分 P。
          all              全部
