...
{
    private const string PlainUrl = "https://www.bilibili.com/video/BV1xx411c7XD/";
    ...
    {
        return PageSelect.Resolve(new DownloadRequest { Pages = pages }, MakeVInfo(pageCount, index), url ?? PlainUrl);
    }
