...
internal static class PlayViewReplyFixtures
{
    ...
    /// </summary>
    public static PlayViewReply Ugc( ) => RoundTrip(new PlayViewReply
    {
    ...
    /// </summary>
    public static PlayViewReply Bangumi( ) => RoundTrip(new PlayViewReply
    {
        VideoInfo = new VideoInfo
        {
            Quality = 125,
    ...
    /// </summary>
    public static PlayViewReply Empty( ) => RoundTrip(new PlayViewReply( ));
