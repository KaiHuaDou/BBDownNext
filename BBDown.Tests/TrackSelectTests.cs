...
public class TrackSelectTests
{
    ...
    public void SortTracks_NoPriorityPrefersNative1080POverAiRepair( )
    {
        ...
        var sorted = TrackSelect.SortTracks(tracks, new Dictionary<string, int>( ), new Dictionary<string, byte>( ), videoAscending: false, encodingFirst: false);
    ...
    public void SortTracks_ExplicitAiRepairPriorityPutsItFirst( )
    {
        ...
        var sorted = TrackSelect.SortTracks(tracks, dfn, new Dictionary<string, byte>( ), videoAscending: false, encodingFirst: false);
